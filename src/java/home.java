...
public class home extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Projeto calculo juros simples e composto</title>");
            out.println("</head>");
            out.println("<center>");
            ...
            out.println("<a href= 'JSimples.html' > Juros Simples </a><br>" 
                                       + "<a href= 'JComposto.html' > Juros Composto </a>");
            out.println("</body>");
            out.println("</html>");
            out.println ("</center>");
        }
